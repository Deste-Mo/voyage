...
export default function OtpScreen() {
  const { verifyOtp, otpHelpCode } = useAuth();
  ...
  return (
    <View style={{ padding: 16 }}>
      <Text style={styles.info}>Un code OTP a été envoyé par SMS.</Text>
      {otpHelpCode ? <Text style={styles.helper}>Code de démonstration: {otpHelpCode}</Text> : null}
